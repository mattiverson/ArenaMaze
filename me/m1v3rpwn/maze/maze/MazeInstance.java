...
import me.m1v3rpwn.maze.kit.Kit;
...
public class MazeInstance {
    ...
    public MazeInstance(int xmin, int zmin) {
        ...
        spec = new ArrayList<>();
        bots = new ArrayList<>();
        gen = new MazeGenerator(xmin, xmin, zmin, zmin, me.m1v3rpwn.maze.main.Main.MAZE_ALT, me.m1v3rpwn.maze.main.Main.me.getServer().getWorlds().get(0), Aesthetic.HAY);
    }
    ...
    public void start(ArrayList<Player> players) {
        pl = players;
        me.m1v3rpwn.maze.main.Main.me.lob.getPlayers().removeAll(pl);
        spec = new ArrayList<>();
        bots = new ArrayList<>();
        single = (pl.size() == 1);
//        int side = 48;
        ...
        for (Player p : pl) {
            ...
            me.m1v3rpwn.maze.main.Main.me.chosenKits.get(p).apply(p);
            Stats.incrementGames(p, single);
        }
        new CountdownRunnable(10, ChatColor.YELLOW + "You have <count> seconds to get into the maze!").runTaskTimer(me.m1v3rpwn.maze.main.Main.me, 20, 20).getTaskId();
        new BukkitRunnable() {
            @Override
            public void run() {
                for (Player p : pl) {
...
//                        Well this line's a mess. v Determines target type     v Random Player                                   v Random Skele, or nothing if there are no skeles
                    ...
                    Kit k = me.m1v3rpwn.maze.main.Main.me.getZombieKit();
                    k.apply(skel);
                    bots.add(skel);
//                        skel.teleport(pl.get(0));
                }
            }
        }.runTaskLater(me.m1v3rpwn.maze.main.Main.me, 220);
        new BukkitRunnable() {
            @Override
            public void run() {
                for (Player p : spec) {
        ...
        }.runTaskTimer(me.m1v3rpwn.maze.main.Main.me, 40, 40);
    ...
    public void finish(final Player winner) {
        ...
        new BukkitRunnable() {
            ...
            public void run() {
                for (Player p1 : spec) {
                    ...
                    p1.teleport(me.m1v3rpwn.maze.main.Main.me.lob.getSpawn());
                ...
                winner.teleport(me.m1v3rpwn.maze.main.Main.me.lob.getSpawn());
                ...
                me.m1v3rpwn.maze.main.Main.me.lob.getPlayers().addAll(spec);
                me.m1v3rpwn.maze.main.Main.me.lob.getPlayers().add(winner);
                pl.clear();
                spec.clear();
                bots.clear();
        ...
        }.runTaskLater(me.m1v3rpwn.maze.main.Main.me, 100);
    ...
    public void addPlayer(Player p) {
        ...
        if (pl.size() >= 1 && !counting) {
            ...
            }.runTaskTimer(me.m1v3rpwn.maze.main.Main.me, 0, 20);
        }
    }
    ...
    public Sign getLobbySign() {
        int x = -41 - (gen.xmin / me.m1v3rpwn.maze.main.Main.GAME_GRID_TILE_SIZE);
        int y = 64 + (gen.zmin / me.m1v3rpwn.maze.main.Main.GAME_GRID_TILE_SIZE);
        int z = -45;
